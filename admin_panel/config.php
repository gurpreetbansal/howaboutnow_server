...
@session_start();
//API host link
$baseurl_domain = "https://clientstagingdev.com/how_about_now";
$firebaseget_Db_URL = "https://how-about-now-101ce.firebaseio.com";
$baseurl = $baseurl_domain."/API/index.php?p=";
$firebaseDb_URL = $firebaseget_Db_URL;
$ImageBaseurl = $baseurl_domain."/admin_panel/uploads/";
